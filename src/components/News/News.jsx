...
import { Avatar, Button, Card, CardActions, CardContent, CardHeader, Grid, Tooltip, Typography } from '@mui/material';
        ...
        {newsData?.map((news, index) => (
          <Grid item xs={4} key={index}>
            <Card>
              ...
              <CardActions>
                <Button size="small" color="primary" href={news?.url} startIcon={<InfoIcon />}>
                  Learn More
                </Button>
              </CardActions>
            </Card>
